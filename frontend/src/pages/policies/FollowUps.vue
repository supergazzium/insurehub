          ...
          >
            ...
            <td class="px-4 py-3 text-slate-600">
              <template v-if="category === 'freelook'">
                <span v-if="r.freelookEndDate">Free Look ถึง {{ fmtDate(r.freelookEndDate) }}</span>
                <span v-else class="rounded-full bg-amber-50 px-2 py-0.5 text-xs font-medium text-amber-700">ยังไม่บันทึกวันสิ้นสุด</span>
              </template>
